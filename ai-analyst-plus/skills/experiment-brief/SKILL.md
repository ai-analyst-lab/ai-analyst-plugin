...
description: >-
  The intake step when someone proposes a test. Auto-generate a structured experiment brief when a
  user expresses intent to test something: hypothesis, ONE north star metric, guardrails,
  pre-registered success criteria, feasibility. Trigger on "I want to test...", "Let's experiment
  with...", "Should we A/B test...", "Can we test whether...", "I think X will improve Y", "We should
  validate...", "Let's test...".
---
...
- **Feasibility flag (MANDATORY):** VIABLE (up to 4 weeks), MARGINAL (4-8 weeks), NOT_VIABLE (over 8 weeks, consider alternatives). Same scale the experiment skill's power script returns.
...
After generating the brief, the next step is ALWAYS the `experiment-designer` plugin agent. Pass the hypothesis, metric definitions, and feasibility estimate as inputs.
...
## Skills Used
- the `metric-spec` skill — for fully specifying the north star metric

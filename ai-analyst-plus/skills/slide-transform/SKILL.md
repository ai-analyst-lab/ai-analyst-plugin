...
description: >-
  Take one bad slide and produce 2-3 redesigned variants with before/after scoring against the
  Data Story Checklist (SO-WHAT, STAKES, EVIDENCE, ASK). Trigger on "fix slide 3", "make this
  slide better", "transform this slide", "improve the headline", "this slide is confusing",
  "redesign this", "show me different ways to present this", and automatically after
  /deck-critique flags slides below 6/12. For whole-deck overhauls use /deck-rescue.
---

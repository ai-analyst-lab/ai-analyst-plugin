...
description: >-
  Adapt analytical findings to the audience: same insight, different framing, detail level, and
  format. Trigger whenever an audience is mentioned (executive, PM, engineer, leadership,
  stakeholders): "prepare this for leadership", "write this for the product team", "create a deck
  for the VP", "make this executive-friendly", "what should I tell the CEO", "how do I present
  this". Default to Product Team format if no audience is specified.
---
...
- "data engineer" / "analytics engineer" / pipeline or instrumentation ownership → Engineering column, with Data Team attribution style (named queries, validation state)

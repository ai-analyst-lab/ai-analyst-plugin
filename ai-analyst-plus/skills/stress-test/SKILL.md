...
name: stress-test
description: >-
  Pressure-test any analysis plan or approach for hidden methodological flaws before execution:
  wrong baselines, survivorship bias, missing segments, uncontrolled confounds, absent kill
  criteria. Trigger on "/stress-test", "stress test this plan", "review my analysis design",
  "check my approach", "is this analysis sound?", "gut-check this analysis", "what am I missing in
  this design?". Produces a 7-point diagnostic with an A-F grade.
---
...
- Complements the **Question Framing skill** (whose Question Brief is the plan) by reviewing the plan after it's written
